...
function renderSettings(m, s, o) {
	...
	o = s.taboption('settings', form.Value, 'network', _('Network'),
	...
	o = s.taboption('settings', form.Flag, 'ipv6', _('IPv6 mode'),
	...
	o = s.taboption('settings', form.Value, 'max_neighbour_reports', _('Max neighbour reports'),
	...
	o = s.taboption('settings', form.Value, 'sta_block_timeout', _('Sta block timeout'),
	...
	o = s.taboption('settings', form.Value, 'local_sta_timeout', _('Local STA timeout'),
	...
	o = s.taboption('settings', form.Value, 'measurement_report_timeout', _('Measurement report timeout'),
	...
	o = s.taboption('settings', form.Value, 'local_sta_update', _('Local sta update'),
	...
	o = s.taboption('settings', form.Value, 'max_retry_band', _('Max retry band'),
	...
	o = s.taboption('settings', form.Value, 'seen_policy_timeout', _('Seen policy timeout'),
	...
	o = s.taboption('settings', form.Value, 'load_balancing_threshold', _('Load balancing threshold'),
	...
	o = s.taboption('settings', form.Value, 'band_steering_threshold', _('Band steering threshold'),
	...
	o = s.taboption('settings', form.Value, 'remote_update_interval', _('Remote update interval'),
	...
	o = s.taboption('settings', form.Value, 'remote_node_timeout', _('Remote node timeout'),
	...
	o = s.taboption('settings', form.Flag, 'assoc_steering', _('Assoc steering'),
		_('Allow rejecting assoc requests for steering purposes')
	);
	o.optional = true;

	o = s.taboption('settings', form.Flag, 'probe_steering', _('Probe steering'),
		_('Allow ignoring probe requests for steering purposes')
	);
	o.optional = true;

	o = s.taboption('settings', form.Value, 'min_connect_snr', _('Min connect SNR'),
	...
	o = s.taboption('settings', form.Value, 'min_snr', _('Min SNR'),
	...
	o = s.taboption('settings', form.Value, 'min_snr_kick_delay', _('Min SNR kick delay'),
	...
	o = s.taboption('settings', form.Value, 'roam_process_timeout', _('Roam process timeout'),
	...
	o = s.taboption('settings', form.Value, 'roam_scan_snr', _('Roam scan SNR'),
	...
	o = s.taboption('settings', form.Value, 'roam_scan_tries', _('Roam scan tries'),
	...
	o = s.taboption('settings', form.Value, 'roam_scan_interval', _('Roam scan interval'),
	...
	o = s.taboption('settings', form.Value, 'roam_trigger_snr', _('Roam trigger SNR'),
	...
	o = s.taboption('settings', form.Value, 'roam_trigger_interval', _('Roam trigger interval'),
	...
	o = s.taboption('settings', form.Value, 'roam_kick_delay', _('Roam kick delay'),
	...
	o = s.taboption('settings', form.Value, 'signal_diff_threshold', _('Signal diff threshold'),
	...
	o = s.taboption('settings', form.Value, 'initial_connect_delay', _('Initial connect delay'),
	...
	o = s.taboption('settings', form.Flag, 'load_kick_enabled', _('Load kick enabled'),
		_('Enable kicking client on excessive channel load')
	);
	o.optional = true;

	o = s.taboption('settings', form.Value, 'load_kick_threshold', _('Load kick threshold'),
	...
	o = s.taboption('settings', form.Value, 'load_kick_delay', _('Load kick delay'),
	...
	o = s.taboption('settings', form.Value, 'load_kick_min_clients', _('Load kick min clients'),
	...
	o = s.taboption('settings', form.Value, 'band_steering_interval', _('Band steering interval'),
	...
	o = s.taboption('settings', form.Value, 'band_steering_min_snr', _('Band steering min SNR'),
	...
	o = s.taboption('settings', form.Value, 'node_up_script', _('Node up script'),
		_('Script to run after bringing up a node')
	);
	o.optional = true;
	o.datatype = 'string';

	o = s.taboption('settings', form.MultiValue, 'event_log_types', _('Event log types'),
	...
	o = s.taboption('settings', form.DynamicList, 'ssid_list', _('SSID list'),
